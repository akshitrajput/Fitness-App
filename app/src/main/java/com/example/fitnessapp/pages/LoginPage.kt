...
fun LoginPage(modifier: Modifier = Modifier,navController: NavController,authViewModel: AuthViewModel) {
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = {
                Text("Email Address", fontFamily = poppinsFontFamily)
            }
        )
        Spacer(modifier = Modifier.height(20.dp))
        OutlinedTextField(
            ...
            label = {
                Text("Password", fontFamily = poppinsFontFamily)
        ...
        TextButton(
            ...
            Text(text = "Don't have an account, Signup", fontFamily = poppinsFontFamily)
        }
